...
5.  **`.eslintrc.js`**: This is a configuration file for [ESLint](https://eslint.org/). ESLint is a very popular linting utility package.
...
13. **`tsconfig.json`**: All TypeScript specific configurations
